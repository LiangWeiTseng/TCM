...
---
### 🚀 線上使用介面
**(https://huggingface.co/spaces/adetectora/formula-altsearch)**

### 📖 使用說明
1. **輸入格式**：藥方名稱與劑量請以冒號隔開，多個品項以空白隔開。
   * 範例：`葛根湯:4.0 芍藥甘草湯:2.0`
2. **搜尋邏輯**：系統會自動計算各廠牌資料庫中，成分重疊度最高的複方與單方組合。
3. **資料庫**：支援順天堂、科達、莊松榮等多家藥廠資料。

致謝：曾建霖的python教學、呂易芩的討論與idea、林品銓醫師的討論優化
